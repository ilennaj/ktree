...
for j, (t1, t2, ds) in enumerate(classes):
    print(t1, t2, ds)
    trainloaders, validloaders, testloader = dataset_weighted_split_all(bs, t1, t2, weighting, trials, ds, padded=True)
    for i in range(trials):
        for k, trees in enumerate(trees_set):
            ...
            np.save('./results/20200513/k_tree_acc_orig_'+str(class_set)+'.npy', acc)
            np.save('./results/20200513/k_tree_loss_orig_'+str(class_set)+'.npy', loss)
